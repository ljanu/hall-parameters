...
return [
    ...
    "text"   => array(
        ...
        // construction
        "construction_parameters"      => "construction parameters",
        "dimension"                    => "dimension",
        "width"                        => "width",
        "length"                       => "length",
        "height"                       => "height",
        ...
        "flat_roof_left"               => "flat roof sloping to the left",
        "flat_roof_right"              => "flat roof sloping to the right",
        "limitations"                  => "limitations",
        "roof_pitch"                   => "roof pitch",
        "max_module_size"              => "max module size",
        ...
        "load"                         => "load",
        "insulated"                    => "insulated",
        "basic_color_design"           => "basic color design",
        "color_roof"                   => "color roof",
        ...
        "bottom_edge_facade"           => "bottom edge facade",
        "fire_resistance"              => "fire resistance",
        "fire_resistance_construction" => "fire resistance construction",
